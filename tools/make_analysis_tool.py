...
import argparse
import sys
sys.path.insert(0, r"c:\Users\n.patsalidis\Desktop\PHD\REPOSITORIES\unified_md_pipeline\package")
...
def main():
    ...
    supra = mdp.supraClass(margs['topol'],margs['connectivity'],**init_kwargs)
